                                                                ...
                                                                <tr>
                                                                    <td class="es-m-p0r esd-container-frame" width="180" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-m-p0l es-p15l es-m-txt-c" align="center" style="font-size:0"><a href="https://viewstripo.email/" target="_blank"><img src="https://tlr.stripocdn.email/content/guids/CABINET_5ebd51945adb862745b1a105fbb2c4f4/images/431502878865957.png" alt="Petshop logo" title="Petshop logo" width="118"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="es-m-p0r es-m-p20b esd-container-frame" width="178" valign="top" align="center">
                                                                            <table width="100%" cellspacing="0" cellpadding="0">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-image" align="center" style="font-size:0"><a href="https://viewstripo.email" target="_blank"><img src="{{ $message->embed($order->product_image_url) }}" alt="Natural Balance L.I.D., sale 30%" class="adapt-img" title="Natural Balance L.I.D., sale 30%" width="125"></a></td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        </td>
                                                                                            ...
                                                                                            <table style="width: 100%;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td style="text-align: center;" width="60">{{ $order->product_qty }}</td>
                                                                                                        <td style="text-align: center;" width="100">${{ $order->product_price }}.00</td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                            <p><br></p>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text" align="right">
                                                                                        <table style="width: 500px;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="right">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td style="text-align: right; font-size: 18px; line-height: 150%;">Subtotal ({{ $orders->sum('product_qty') }} items):</td>
                                                                                                    <td style="text-align: right; font-size: 18px; line-height: 150%;">${{ $orders->sum('product_price') }}.00</td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td style="text-align: right; font-size: 18px; line-height: 150%; color: #d48344;"><strong>${{ $orders->sum('product_price') }}.00</strong></td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                        <p style="line-height: 150%;"><br></p>
