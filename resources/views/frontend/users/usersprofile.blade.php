        ...
        <div class="card">
          <div class="card-body">
            <nav class="nav flex-column nav-pills nav-gap-y-1">
              <a href="#profile" data-toggle="tab" class="nav-item nav-link has-icon nav-link-faded active bg-white text-dark">
              ...
              <a href="#account" data-toggle="tab" class="nav-item nav-link has-icon nav-link-faded bg-white text-dark">
              ...
              <a href="#security" data-toggle="tab" class="nav-item nav-link has-icon nav-link-faded bg-white text-dark">
              ...
              <a href="#notification" data-toggle="tab" class="nav-item nav-link has-icon nav-link-faded bg-white text-dark">
              ...
              <a href="#billing" data-toggle="tab" class="nav-item nav-link has-icon nav-link-faded bg-white text-dark">
            ...
            <div class="tab-pane active" id="profile">
              ...
              <form action="{{route('profile.update', $user->id)}}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="fullName" id="fullName" aria-describedby="fullNameHelp" placeholder="Enter your fullname" value="{{ $user->name ?? "" }}">
                </div>
                <div class="form-group">
                  <label for="email">Your Email</label>
                  <input type="text" class="form-control" name="email" id="email" aria-describedby="fullEmailHelp" placeholder="Enter your Email" value="{{ $user->email ?? "" }}">
                </div>
                <div class="form-group">
                  <label for="mobile">Mobile</label>
                  <input type="number" class="form-control" name="mobile" id="mobile" placeholder="Enter your Mobile" value="{{ $user->phone ?? "" }}">
                </div>
                <div class="form-group">
                  <label for="address1">Address</label>
                  <input type="text" class="form-control" name="address" id="address" placeholder="Address(House No, Building, Street, Area)" value="{{ $user->user_detail->address1 ?? "" }}">
                </div>
                <div class="form-row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="city">City</label>
                            <input type="text" class="form-control" name="city" id="city" placeholder="City" value="{{ $user->user_detail->city ?? "" }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="pincode">Pin Code</label>
                            <input type="text" class="form-control" name="pincode" id="pincode" placeholder="Pin Code" value="{{ $user->user_detail->pincode ?? "" }}">
                        </div>
                    </div>
                </div>
...
@push('css')
  <link rel="stylesheet" href="{{ asset('css/manual/userprofile.css') }}">
@endpush
